...
const Hero = () => {
  return (
    <div
      ...
      className="max-w-screen-xl mx-auto w-full h-screen flex items-center justify-center  max-sm:flex-col"
    >
      <div className="z-[10] relative w-[65vw] pb-14 heading ">
      ...
      <div className="h-16 hidden max-sm:block">
        <img
